...
def get_args():
    ...
    parser.add_argument('--data_dir', type=str, default='/home/liruihuang/openscene/data_nus', help='Where is the base logging directory')
    parser.add_argument('--output_dir', type=str, default='/home/liruihuang/openscene/data_nus/nuscenes_2d/nuscenes_multiview_openseg', help='Where is the base logging directory')
    parser.add_argument('--split', type=str, default='train', help='split: "train"| "val" ')
    parser.add_argument('--openseg_model', type=str, default='/home/liruihuang/openscene/openseg_exported_clip', help='Where is the exported OpenSeg model')
...
def main(args):
    ...
    for i in trange(total_num):
        ...
        path = '/home/liruihuang/openscene/data_nus/nuscenes_3d/train/3cc5ce65deeb4ce283aeca6cc31921f4.pth'  
        # process_one_scene(data_paths[i], out_dir, args)
        process_one_scene(path, out_dir, args)
